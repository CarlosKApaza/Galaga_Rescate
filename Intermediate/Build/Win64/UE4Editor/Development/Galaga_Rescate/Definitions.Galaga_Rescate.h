...
#define UE_PROJECT_NAME Galaga_Rescate
#define UE_TARGET_NAME Galaga_RescateEditor
#define UE_MODULE_NAME "Galaga_Rescate"
...
#define GALAGA_RESCATE_API DLLEXPORT
